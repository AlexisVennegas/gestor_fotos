...
function openModal(mode,id){
	...
	//Modo edición
		...
		dateCreate.value = pictures[id].dateCreate;
	}
...
async function sendData() {
  ...
  formData.append("dateCreate", new Date(dateCreate.value).toISOString().slice(0, 10));
 
 	// console.log(dateCreate.value);
