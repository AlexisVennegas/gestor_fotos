...
@section('content')
	...
	<section id="pictures" class="row g-3" style="gap: 12%;">
		@if(!count($pictures))
			<h2>¡Añade tus primeras fotos!</h2>
		@else
			@foreach(collect($pictures)->sortdesc()->all() as $picture)
				<div class="card col-md-3 col-sm-6 col-12 mb-4" id="img-{{$picture->id}}">
					...
					<div class="card-body">
						...
						<p class="dateText">
						<?php
						echo $picture->dateCreate
						?>
						</p>
					</div>
						
						<div class="row mt-3 divPad">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
			...
			<div class="row mb-3">
			    ...
			    <div class="col-sm-10">
			     	<input type="php " maxlength="80" class="form-control" id="title">
			    </div>
			</div>
			<div class="row mb-3">
				...
				<div class="row mb-3" id="dateInputContainer">
					<label for="date" class="col-sm-2 col-form-label">Fecha de la Foto</label>
					<div class="col-sm-10">
						<input type="date" id="dateCreate" name="date" class="form-control">
					</div>
				</div>
			</div>
